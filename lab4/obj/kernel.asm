...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	651040ef          	jal	ra,ffffffffc0204e9e <memset>
...
ffffffffc020005a:	ea258593          	addi	a1,a1,-350 # ffffffffc0204ef8 <etext>
ffffffffc020005e:	00005517          	auipc	a0,0x5
ffffffffc0200062:	eba50513          	addi	a0,a0,-326 # ffffffffc0204f18 <etext+0x20>
...
ffffffffc020007e:	62c040ef          	jal	ra,ffffffffc02046aa <proc_init>
...
ffffffffc0200092:	00d040ef          	jal	ra,ffffffffc020489e <cpu_idle>
...
ffffffffc02000b2:	e7250513          	addi	a0,a0,-398 # ffffffffc0204f20 <etext+0x28>
...
ffffffffc0200180:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200182:	0f3040ef          	jal	ra,ffffffffc0204a74 <vprintfmt>
    return cnt;
}
...
ffffffffc02001b4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001b6:	0bf040ef          	jal	ra,ffffffffc0204a74 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001dc:	d8050513          	addi	a0,a0,-640 # ffffffffc0204f58 <etext+0x60>
void print_kerninfo(void) {
...
ffffffffc02001f2:	d8a50513          	addi	a0,a0,-630 # ffffffffc0204f78 <etext+0x80>
ffffffffc02001f6:	f99ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001fa:	00005597          	auipc	a1,0x5
ffffffffc02001fe:	cfe58593          	addi	a1,a1,-770 # ffffffffc0204ef8 <etext>
ffffffffc0200202:	00005517          	auipc	a0,0x5
ffffffffc0200206:	d9650513          	addi	a0,a0,-618 # ffffffffc0204f98 <etext+0xa0>
...
ffffffffc020021a:	da250513          	addi	a0,a0,-606 # ffffffffc0204fb8 <etext+0xc0>
...
ffffffffc020022e:	dae50513          	addi	a0,a0,-594 # ffffffffc0204fd8 <etext+0xe0>
...
ffffffffc020025c:	da050513          	addi	a0,a0,-608 # ffffffffc0204ff8 <etext+0x100>
}
...
ffffffffc020026c:	cc060613          	addi	a2,a2,-832 # ffffffffc0204f28 <etext+0x30>
ffffffffc0200270:	04d00593          	li	a1,77
ffffffffc0200274:	00005517          	auipc	a0,0x5
ffffffffc0200278:	ccc50513          	addi	a0,a0,-820 # ffffffffc0204f40 <etext+0x48>
void print_stackframe(void) {
...
ffffffffc020038c:	2f5040ef          	jal	ra,ffffffffc0204e80 <strchr>
...
ffffffffc02003b0:	2a7040ef          	jal	ra,ffffffffc0204e56 <strcmp>
...
ffffffffc02003c4:	293040ef          	jal	ra,ffffffffc0204e56 <strcmp>
...
ffffffffc020042a:	257040ef          	jal	ra,ffffffffc0204e80 <strchr>
...
ffffffffc020059e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02005a0:	111040ef          	jal	ra,ffffffffc0204eb0 <memcpy>
    return 0;
}
...
ffffffffc02005c4:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005c6:	0eb040ef          	jal	ra,ffffffffc0204eb0 <memcpy>
    return 0;
}
...
ffffffffc0200c68:	3bc70713          	addi	a4,a4,956 # ffffffffc0207020 <nbase>
...
ffffffffc0201820:	80478793          	addi	a5,a5,-2044 # ffffffffc0207020 <nbase>
...
ffffffffc0201ad8:	54c78793          	addi	a5,a5,1356 # ffffffffc0207020 <nbase>
...
ffffffffc0201d2a:	174030ef          	jal	ra,ffffffffc0204e9e <memset>
    return page - pages + nbase;
...
ffffffffc0201dbc:	0e2030ef          	jal	ra,ffffffffc0204e9e <memset>
    return page - pages + nbase;
...
ffffffffc0202456:	1ef020ef          	jal	ra,ffffffffc0204e44 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020245a:	100b0593          	addi	a1,s6,256
ffffffffc020245e:	10000513          	li	a0,256
ffffffffc0202462:	1f5020ef          	jal	ra,ffffffffc0204e56 <strcmp>
...
ffffffffc0202496:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fde8b08>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020249a:	167020ef          	jal	ra,ffffffffc0204e00 <strlen>
...
ffffffffc0202b46:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b48:	512010ef          	jal	ra,ffffffffc020405a <swapfs_init>
...
ffffffffc0202dd6:	24ed8d93          	addi	s11,s11,590 # ffffffffc0207020 <nbase>
...
ffffffffc0203364:	5c7000ef          	jal	ra,ffffffffc020412a <swapfs_write>
...
ffffffffc0203402:	491000ef          	jal	ra,ffffffffc0204092 <swapfs_read>
...
ffffffffc0203984:	fe868693          	addi	a3,a3,-24 # ffffffffc0206968 <default_pmm_manager+0xd38>
...
ffffffffc02039a4:	00868693          	addi	a3,a3,8 # ffffffffc02069a8 <default_pmm_manager+0xd78>
...
ffffffffc02039c4:	fc868693          	addi	a3,a3,-56 # ffffffffc0206988 <default_pmm_manager+0xd58>
...
ffffffffc0203b74:	f5850513          	addi	a0,a0,-168 # ffffffffc0206ac8 <default_pmm_manager+0xe98>
ffffffffc0203b78:	e16fc0ef          	jal	ra,ffffffffc020018e <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203b7c:	00003697          	auipc	a3,0x3
ffffffffc0203b80:	f7468693          	addi	a3,a3,-140 # ffffffffc0206af0 <default_pmm_manager+0xec0>
...
ffffffffc0203bac:	f6050513          	addi	a0,a0,-160 # ffffffffc0206b08 <default_pmm_manager+0xed8>
...
ffffffffc0203c62:	3c268693          	addi	a3,a3,962 # ffffffffc0207020 <nbase>
...
ffffffffc0203d00:	e9c50513          	addi	a0,a0,-356 # ffffffffc0206b98 <default_pmm_manager+0xf68>
...
ffffffffc0203d1a:	ea250513          	addi	a0,a0,-350 # ffffffffc0206bb8 <default_pmm_manager+0xf88>
}
...
ffffffffc0203d28:	cbc68693          	addi	a3,a3,-836 # ffffffffc02069e0 <default_pmm_manager+0xdb0>
...
ffffffffc0203d48:	d2468693          	addi	a3,a3,-732 # ffffffffc0206a68 <default_pmm_manager+0xe38>
...
ffffffffc0203d68:	d3468693          	addi	a3,a3,-716 # ffffffffc0206a98 <default_pmm_manager+0xe68>
...
ffffffffc0203da8:	c2468693          	addi	a3,a3,-988 # ffffffffc02069c8 <default_pmm_manager+0xd98>
...
ffffffffc0203dc8:	c7468693          	addi	a3,a3,-908 # ffffffffc0206a38 <default_pmm_manager+0xe08>
...
ffffffffc0203de8:	c4468693          	addi	a3,a3,-956 # ffffffffc0206a28 <default_pmm_manager+0xdf8>
...
ffffffffc0203e08:	c1468693          	addi	a3,a3,-1004 # ffffffffc0206a18 <default_pmm_manager+0xde8>
...
ffffffffc0203e28:	c3468693          	addi	a3,a3,-972 # ffffffffc0206a58 <default_pmm_manager+0xe28>
...
ffffffffc0203e48:	c0468693          	addi	a3,a3,-1020 # ffffffffc0206a48 <default_pmm_manager+0xe18>
...
ffffffffc0203ea0:	cd468693          	addi	a3,a3,-812 # ffffffffc0206b70 <default_pmm_manager+0xf40>
...
ffffffffc0203ee0:	c6468693          	addi	a3,a3,-924 # ffffffffc0206b40 <default_pmm_manager+0xf10>
...
ffffffffc0203f18:	c4c68693          	addi	a3,a3,-948 # ffffffffc0206b60 <default_pmm_manager+0xf30>
...
ffffffffc0203f38:	bf468693          	addi	a3,a3,-1036 # ffffffffc0206b28 <default_pmm_manager+0xef8>
...
ffffffffc0203f7c:	c555                	beqz	a0,ffffffffc0204028 <do_pgfault+0xd4>
ffffffffc0203f7e:	651c                	ld	a5,8(a0)
ffffffffc0203f80:	0af46463          	bltu	s0,a5,ffffffffc0204028 <do_pgfault+0xd4>
...
ffffffffc0203f8a:	eba9                	bnez	a5,ffffffffc0203fdc <do_pgfault+0x88>
        perm |= READ_WRITE;
    }
...
ffffffffc0203f9a:	c945                	beqz	a0,ffffffffc020404a <do_pgfault+0xf6>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0203f9c:	610c                	ld	a1,0(a0)
ffffffffc0203f9e:	cdb9                	beqz	a1,ffffffffc0203ffc <do_pgfault+0xa8>
...
ffffffffc0203fac:	c7d9                	beqz	a5,ffffffffc020403a <do_pgfault+0xe6>
...
ffffffffc0203fb6:	c1eff0ef          	jal	ra,ffffffffc02033d4 <swap_in>
            if (swap_in_ret == 0) {
ffffffffc0203fba:	c11d                	beqz	a0,ffffffffc0203fe0 <do_pgfault+0x8c>
                } else {
...
ffffffffc0203fc0:	96450513          	addi	a0,a0,-1692 # ffffffffc0206920 <default_pmm_manager+0xcf0>
ffffffffc0203fc4:	9cafc0ef          	jal	ra,ffffffffc020018e <cprintf>
                ret = -E_NO_MEM;
            }

            // 设置页面的虚拟地址 pra_vaddr 为 addr
            page->pra_vaddr = addr;
ffffffffc0203fc8:	6722                	ld	a4,8(sp)
   ...
   ret = 0;
ffffffffc0203fca:	4781                	li	a5,0
            page->pra_vaddr = addr;
ffffffffc0203fcc:	ff00                	sd	s0,56(a4)
failed:
    return ret;
}
...
ffffffffc0203fd6:	853e                	mv	a0,a5
ffffffffc0203fd8:	6145                	addi	sp,sp,48
ffffffffc0203fda:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0203fdc:	495d                	li	s2,23
ffffffffc0203fde:	b77d                	j	ffffffffc0203f8c <do_pgfault+0x38>
                int page_insert_ret = page_insert(mm->pgdir, page, addr, perm);
ffffffffc0203fe0:	65a2                	ld	a1,8(sp)
ffffffffc0203fe2:	6c88                	ld	a0,24(s1)
ffffffffc0203fe4:	86ca                	mv	a3,s2
ffffffffc0203fe6:	8622                	mv	a2,s0
ffffffffc0203fe8:	f65fd0ef          	jal	ra,ffffffffc0201f4c <page_insert>
                if (page_insert_ret == 0) {
ffffffffc0203fec:	e51d                	bnez	a0,ffffffffc020401a <do_pgfault+0xc6>
                    swap_map_swappable(mm, addr, page, 1);
ffffffffc0203fee:	6622                	ld	a2,8(sp)
ffffffffc0203ff0:	4685                	li	a3,1
ffffffffc0203ff2:	85a2                	mv	a1,s0
ffffffffc0203ff4:	8526                	mv	a0,s1
ffffffffc0203ff6:	abaff0ef          	jal	ra,ffffffffc02032b0 <swap_map_swappable>
ffffffffc0203ffa:	b7f9                	j	ffffffffc0203fc8 <do_pgfault+0x74>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203ffc:	6c88                	ld	a0,24(s1)
ffffffffc0203ffe:	864a                	mv	a2,s2
ffffffffc0204000:	85a2                	mv	a1,s0
ffffffffc0204002:	a99fe0ef          	jal	ra,ffffffffc0202a9a <pgdir_alloc_page>
   ret = 0;
ffffffffc0204006:	4781                	li	a5,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204008:	f179                	bnez	a0,ffffffffc0203fce <do_pgfault+0x7a>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc020400a:	00003517          	auipc	a0,0x3
ffffffffc020400e:	8c650513          	addi	a0,a0,-1850 # ffffffffc02068d0 <default_pmm_manager+0xca0>
ffffffffc0204012:	97cfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204016:	57f1                	li	a5,-4
            goto failed;
ffffffffc0204018:	bf5d                	j	ffffffffc0203fce <do_pgfault+0x7a>
                    cprintf("page_insert in do_pgfault failed\n");
ffffffffc020401a:	00003517          	auipc	a0,0x3
ffffffffc020401e:	8de50513          	addi	a0,a0,-1826 # ffffffffc02068f8 <default_pmm_manager+0xcc8>
ffffffffc0204022:	96cfc0ef          	jal	ra,ffffffffc020018e <cprintf>
                    ret = -E_NO_MEM;
ffffffffc0204026:	b74d                	j	ffffffffc0203fc8 <do_pgfault+0x74>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0204028:	85a2                	mv	a1,s0
ffffffffc020402a:	00003517          	auipc	a0,0x3
ffffffffc020402e:	85650513          	addi	a0,a0,-1962 # ffffffffc0206880 <default_pmm_manager+0xc50>
ffffffffc0204032:	95cfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    int ret = -E_INVAL;
ffffffffc0204036:	57f5                	li	a5,-3
        goto failed;
ffffffffc0204038:	bf59                	j	ffffffffc0203fce <do_pgfault+0x7a>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc020403a:	00003517          	auipc	a0,0x3
ffffffffc020403e:	90650513          	addi	a0,a0,-1786 # ffffffffc0206940 <default_pmm_manager+0xd10>
ffffffffc0204042:	94cfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204046:	57f1                	li	a5,-4
            goto failed;
ffffffffc0204048:	b759                	j	ffffffffc0203fce <do_pgfault+0x7a>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc020404a:	00003517          	auipc	a0,0x3
ffffffffc020404e:	86650513          	addi	a0,a0,-1946 # ffffffffc02068b0 <default_pmm_manager+0xc80>
ffffffffc0204052:	93cfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204056:	57f1                	li	a5,-4
        goto failed;
ffffffffc0204058:	bf9d                	j	ffffffffc0203fce <do_pgfault+0x7a>

ffffffffc020405a <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
swapfs_init(void) {
ffffffffc020405e:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0204060:	d1cfc0ef          	jal	ra,ffffffffc020057c <ide_device_valid>
ffffffffc0204064:	cd01                	beqz	a0,ffffffffc020407c <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0204066:	4505                	li	a0,1
ffffffffc0204068:	d1afc0ef          	jal	ra,ffffffffc0200582 <ide_device_size>
}
ffffffffc020406c:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc020406e:	810d                	srli	a0,a0,0x3
ffffffffc0204070:	00012797          	auipc	a5,0x12
ffffffffc0204074:	52a7b023          	sd	a0,1312(a5) # ffffffffc0216590 <max_swap_offset>
}
ffffffffc0204078:	0141                	addi	sp,sp,16
ffffffffc020407a:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc020407c:	00003617          	auipc	a2,0x3
ffffffffc0204080:	b5460613          	addi	a2,a2,-1196 # ffffffffc0206bd0 <default_pmm_manager+0xfa0>
ffffffffc0204084:	45b5                	li	a1,13
ffffffffc0204086:	00003517          	auipc	a0,0x3
ffffffffc020408a:	b6a50513          	addi	a0,a0,-1174 # ffffffffc0206bf0 <default_pmm_manager+0xfc0>
ffffffffc020408e:	bc2fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0204092 <swapfs_read>:
...
ffffffffc0204096:	00855793          	srli	a5,a0,0x8
ffffffffc020409a:	cfb9                	beqz	a5,ffffffffc02040f8 <swapfs_read+0x66>
ffffffffc020409c:	00012717          	auipc	a4,0x12
ffffffffc02040a0:	4f470713          	addi	a4,a4,1268 # ffffffffc0216590 <max_swap_offset>
ffffffffc02040a4:	6318                	ld	a4,0(a4)
ffffffffc02040a6:	04e7f963          	bleu	a4,a5,ffffffffc02040f8 <swapfs_read+0x66>
    return page - pages + nbase;
ffffffffc02040aa:	00012717          	auipc	a4,0x12
ffffffffc02040ae:	45670713          	addi	a4,a4,1110 # ffffffffc0216500 <pages>
ffffffffc02040b2:	6310                	ld	a2,0(a4)
ffffffffc02040b4:	00003717          	auipc	a4,0x3
ffffffffc02040b8:	f6c70713          	addi	a4,a4,-148 # ffffffffc0207020 <nbase>
    return KADDR(page2pa(page));
ffffffffc02040bc:	00012697          	auipc	a3,0x12
ffffffffc02040c0:	3d468693          	addi	a3,a3,980 # ffffffffc0216490 <npage>
    return page - pages + nbase;
ffffffffc02040c4:	40c58633          	sub	a2,a1,a2
ffffffffc02040c8:	630c                	ld	a1,0(a4)
ffffffffc02040ca:	8619                	srai	a2,a2,0x6
    return KADDR(page2pa(page));
ffffffffc02040cc:	577d                	li	a4,-1
ffffffffc02040ce:	6294                	ld	a3,0(a3)
    return page - pages + nbase;
ffffffffc02040d0:	962e                	add	a2,a2,a1
    return KADDR(page2pa(page));
ffffffffc02040d2:	8331                	srli	a4,a4,0xc
ffffffffc02040d4:	8f71                	and	a4,a4,a2
ffffffffc02040d6:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02040da:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc02040dc:	02d77a63          	bleu	a3,a4,ffffffffc0204110 <swapfs_read+0x7e>
ffffffffc02040e0:	00012797          	auipc	a5,0x12
ffffffffc02040e4:	41078793          	addi	a5,a5,1040 # ffffffffc02164f0 <va_pa_offset>
ffffffffc02040e8:	639c                	ld	a5,0(a5)
}
ffffffffc02040ea:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02040ec:	46a1                	li	a3,8
ffffffffc02040ee:	963e                	add	a2,a2,a5
ffffffffc02040f0:	4505                	li	a0,1
}
ffffffffc02040f2:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02040f4:	c94fc06f          	j	ffffffffc0200588 <ide_read_secs>
ffffffffc02040f8:	86aa                	mv	a3,a0
ffffffffc02040fa:	00003617          	auipc	a2,0x3
ffffffffc02040fe:	b0e60613          	addi	a2,a2,-1266 # ffffffffc0206c08 <default_pmm_manager+0xfd8>
ffffffffc0204102:	45d1                	li	a1,20
ffffffffc0204104:	00003517          	auipc	a0,0x3
ffffffffc0204108:	aec50513          	addi	a0,a0,-1300 # ffffffffc0206bf0 <default_pmm_manager+0xfc0>
ffffffffc020410c:	b44fc0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc0204110:	86b2                	mv	a3,a2
ffffffffc0204112:	06900593          	li	a1,105
ffffffffc0204116:	00002617          	auipc	a2,0x2
ffffffffc020411a:	b6a60613          	addi	a2,a2,-1174 # ffffffffc0205c80 <default_pmm_manager+0x50>
ffffffffc020411e:	00002517          	auipc	a0,0x2
ffffffffc0204122:	b8a50513          	addi	a0,a0,-1142 # ffffffffc0205ca8 <default_pmm_manager+0x78>
ffffffffc0204126:	b2afc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020412a <swapfs_write>:
...
ffffffffc020412e:	00855793          	srli	a5,a0,0x8
ffffffffc0204132:	cfb9                	beqz	a5,ffffffffc0204190 <swapfs_write+0x66>
ffffffffc0204134:	00012717          	auipc	a4,0x12
ffffffffc0204138:	45c70713          	addi	a4,a4,1116 # ffffffffc0216590 <max_swap_offset>
ffffffffc020413c:	6318                	ld	a4,0(a4)
ffffffffc020413e:	04e7f963          	bleu	a4,a5,ffffffffc0204190 <swapfs_write+0x66>
    return page - pages + nbase;
ffffffffc0204142:	00012717          	auipc	a4,0x12
ffffffffc0204146:	3be70713          	addi	a4,a4,958 # ffffffffc0216500 <pages>
ffffffffc020414a:	6310                	ld	a2,0(a4)
ffffffffc020414c:	00003717          	auipc	a4,0x3
ffffffffc0204150:	ed470713          	addi	a4,a4,-300 # ffffffffc0207020 <nbase>
    return KADDR(page2pa(page));
ffffffffc0204154:	00012697          	auipc	a3,0x12
ffffffffc0204158:	33c68693          	addi	a3,a3,828 # ffffffffc0216490 <npage>
    return page - pages + nbase;
ffffffffc020415c:	40c58633          	sub	a2,a1,a2
ffffffffc0204160:	630c                	ld	a1,0(a4)
ffffffffc0204162:	8619                	srai	a2,a2,0x6
    return KADDR(page2pa(page));
ffffffffc0204164:	577d                	li	a4,-1
ffffffffc0204166:	6294                	ld	a3,0(a3)
    return page - pages + nbase;
ffffffffc0204168:	962e                	add	a2,a2,a1
    return KADDR(page2pa(page));
ffffffffc020416a:	8331                	srli	a4,a4,0xc
ffffffffc020416c:	8f71                	and	a4,a4,a2
ffffffffc020416e:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204172:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc0204174:	02d77a63          	bleu	a3,a4,ffffffffc02041a8 <swapfs_write+0x7e>
ffffffffc0204178:	00012797          	auipc	a5,0x12
ffffffffc020417c:	37878793          	addi	a5,a5,888 # ffffffffc02164f0 <va_pa_offset>
ffffffffc0204180:	639c                	ld	a5,0(a5)
}
ffffffffc0204182:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204184:	46a1                	li	a3,8
ffffffffc0204186:	963e                	add	a2,a2,a5
ffffffffc0204188:	4505                	li	a0,1
}
ffffffffc020418a:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020418c:	c20fc06f          	j	ffffffffc02005ac <ide_write_secs>
ffffffffc0204190:	86aa                	mv	a3,a0
ffffffffc0204192:	00003617          	auipc	a2,0x3
ffffffffc0204196:	a7660613          	addi	a2,a2,-1418 # ffffffffc0206c08 <default_pmm_manager+0xfd8>
ffffffffc020419a:	45e5                	li	a1,25
ffffffffc020419c:	00003517          	auipc	a0,0x3
ffffffffc02041a0:	a5450513          	addi	a0,a0,-1452 # ffffffffc0206bf0 <default_pmm_manager+0xfc0>
ffffffffc02041a4:	aacfc0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc02041a8:	86b2                	mv	a3,a2
ffffffffc02041aa:	06900593          	li	a1,105
ffffffffc02041ae:	00002617          	auipc	a2,0x2
ffffffffc02041b2:	ad260613          	addi	a2,a2,-1326 # ffffffffc0205c80 <default_pmm_manager+0x50>
ffffffffc02041b6:	00002517          	auipc	a0,0x2
ffffffffc02041ba:	af250513          	addi	a0,a0,-1294 # ffffffffc0205ca8 <default_pmm_manager+0x78>
ffffffffc02041be:	a92fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02041c2 <kernel_thread_entry>:
.text
.globl kernel_thread_entry
kernel_thread_entry:        # void kernel_thread(void)
	move a0, s1
ffffffffc02041c2:	8526                	mv	a0,s1
	jalr s0
ffffffffc02041c4:	9402                	jalr	s0

	jal do_exit
ffffffffc02041c6:	4c8000ef          	jal	ra,ffffffffc020468e <do_exit>

ffffffffc02041ca <alloc_proc>:
...
alloc_proc(void) {
ffffffffc02041ca:	1141                	addi	sp,sp,-16
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc02041cc:	0e800513          	li	a0,232
alloc_proc(void) {
ffffffffc02041d0:	e022                	sd	s0,0(sp)
ffffffffc02041d2:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc02041d4:	fc6fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
ffffffffc02041d8:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc02041da:	c529                	beqz	a0,ffffffffc0204224 <alloc_proc+0x5a>
     *       struct trapframe *tf;                       // Trap frame for current interrupt
     *       uintptr_t cr3;                              // CR3 register: the base addr of Page Directroy Table(PDT)
     *       uint32_t flags;                             // Process flag
     *       char name[PROC_NAME_LEN + 1];               // Process name
     */
    proc->state = PROC_UNINIT;  // 设置进程状态为未初始化状态
ffffffffc02041dc:	57fd                	li	a5,-1
ffffffffc02041de:	1782                	slli	a5,a5,0x20
ffffffffc02041e0:	e11c                	sd	a5,0(a0)
    proc->runs = 0;  // 设置运行次数为0
    proc->kstack = 0;  // 分配内核栈空间并赋值给 kstack
    proc->need_resched = 0;  // 设置不需要重新调度
    proc->parent = NULL;  // 父进程为空
    proc->mm = NULL;  // 内存管理结构为空
    memset(&(proc->context), 0, sizeof(struct context));  // 清空上下文信息
ffffffffc02041e2:	07000613          	li	a2,112
ffffffffc02041e6:	4581                	li	a1,0
    proc->runs = 0;  // 设置运行次数为0
ffffffffc02041e8:	00052423          	sw	zero,8(a0)
    proc->kstack = 0;  // 分配内核栈空间并赋值给 kstack
ffffffffc02041ec:	00053823          	sd	zero,16(a0)
    proc->need_resched = 0;  // 设置不需要重新调度
ffffffffc02041f0:	00052c23          	sw	zero,24(a0)
    proc->parent = NULL;  // 父进程为空
ffffffffc02041f4:	02053023          	sd	zero,32(a0)
    proc->mm = NULL;  // 内存管理结构为空
ffffffffc02041f8:	02053423          	sd	zero,40(a0)
    memset(&(proc->context), 0, sizeof(struct context));  // 清空上下文信息
ffffffffc02041fc:	03050513          	addi	a0,a0,48
ffffffffc0204200:	49f000ef          	jal	ra,ffffffffc0204e9e <memset>
    proc->tf = NULL;  // trap frame为空
    proc->cr3 = boot_cr3;  // 获取内核页目录表基地址并赋值给 cr3
ffffffffc0204204:	00012797          	auipc	a5,0x12
ffffffffc0204208:	2f478793          	addi	a5,a5,756 # ffffffffc02164f8 <boot_cr3>
ffffffffc020420c:	639c                	ld	a5,0(a5)
    proc->tf = NULL;  // trap frame为空
ffffffffc020420e:	0a043023          	sd	zero,160(s0)
    proc->flags = 0;  // 标志位初始化为0
ffffffffc0204212:	0a042823          	sw	zero,176(s0)
    proc->cr3 = boot_cr3;  // 获取内核页目录表基地址并赋值给 cr3
ffffffffc0204216:	f45c                	sd	a5,168(s0)
    memset(proc->name, 0, PROC_NAME_LEN);  // 进程名字初始化为空字符串
ffffffffc0204218:	463d                	li	a2,15
ffffffffc020421a:	4581                	li	a1,0
ffffffffc020421c:	0b440513          	addi	a0,s0,180
ffffffffc0204220:	47f000ef          	jal	ra,ffffffffc0204e9e <memset>

    }
    return proc;
}
ffffffffc0204224:	8522                	mv	a0,s0
ffffffffc0204226:	60a2                	ld	ra,8(sp)
ffffffffc0204228:	6402                	ld	s0,0(sp)
ffffffffc020422a:	0141                	addi	sp,sp,16
ffffffffc020422c:	8082                	ret

ffffffffc020422e <forkret>:
...
forkret(void) {
    forkrets(current->tf);
ffffffffc020422e:	00012797          	auipc	a5,0x12
ffffffffc0204232:	27a78793          	addi	a5,a5,634 # ffffffffc02164a8 <current>
ffffffffc0204236:	639c                	ld	a5,0(a5)
ffffffffc0204238:	73c8                	ld	a0,160(a5)
ffffffffc020423a:	95ffc06f          	j	ffffffffc0200b98 <forkrets>

ffffffffc020423e <set_proc_name>:
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc020423e:	1101                	addi	sp,sp,-32
ffffffffc0204240:	e822                	sd	s0,16(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204242:	0b450413          	addi	s0,a0,180
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc0204246:	e426                	sd	s1,8(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204248:	4641                	li	a2,16
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc020424a:	84ae                	mv	s1,a1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020424c:	8522                	mv	a0,s0
ffffffffc020424e:	4581                	li	a1,0
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc0204250:	ec06                	sd	ra,24(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204252:	44d000ef          	jal	ra,ffffffffc0204e9e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204256:	8522                	mv	a0,s0
}
ffffffffc0204258:	6442                	ld	s0,16(sp)
ffffffffc020425a:	60e2                	ld	ra,24(sp)
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020425c:	85a6                	mv	a1,s1
}
ffffffffc020425e:	64a2                	ld	s1,8(sp)
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204260:	463d                	li	a2,15
}
ffffffffc0204262:	6105                	addi	sp,sp,32
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204264:	44d0006f          	j	ffffffffc0204eb0 <memcpy>

ffffffffc0204268 <get_proc_name>:
get_proc_name(struct proc_struct *proc) {
ffffffffc0204268:	1101                	addi	sp,sp,-32
ffffffffc020426a:	e822                	sd	s0,16(sp)
    memset(name, 0, sizeof(name));
ffffffffc020426c:	00012417          	auipc	s0,0x12
ffffffffc0204270:	1f440413          	addi	s0,s0,500 # ffffffffc0216460 <name.1565>
get_proc_name(struct proc_struct *proc) {
ffffffffc0204274:	e426                	sd	s1,8(sp)
    memset(name, 0, sizeof(name));
...
ffffffffc020427e:	ec06                	sd	ra,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc0204280:	41f000ef          	jal	ra,ffffffffc0204e9e <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc0204284:	8522                	mv	a0,s0
}
ffffffffc0204286:	6442                	ld	s0,16(sp)
ffffffffc0204288:	60e2                	ld	ra,24(sp)
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc020428a:	0b448593          	addi	a1,s1,180
}
ffffffffc020428e:	64a2                	ld	s1,8(sp)
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc0204290:	463d                	li	a2,15
}
ffffffffc0204292:	6105                	addi	sp,sp,32
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc0204294:	41d0006f          	j	ffffffffc0204eb0 <memcpy>

ffffffffc0204298 <init_main>:
}
...
ffffffffc0204298:	00012797          	auipc	a5,0x12
ffffffffc020429c:	21078793          	addi	a5,a5,528 # ffffffffc02164a8 <current>
ffffffffc02042a0:	639c                	ld	a5,0(a5)
init_main(void *arg) {
ffffffffc02042a2:	1101                	addi	sp,sp,-32
ffffffffc02042a4:	e426                	sd	s1,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042a6:	43c4                	lw	s1,4(a5)
init_main(void *arg) {
ffffffffc02042a8:	e822                	sd	s0,16(sp)
...
ffffffffc02042ae:	ec06                	sd	ra,24(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042b0:	fb9ff0ef          	jal	ra,ffffffffc0204268 <get_proc_name>
ffffffffc02042b4:	862a                	mv	a2,a0
ffffffffc02042b6:	85a6                	mv	a1,s1
ffffffffc02042b8:	00003517          	auipc	a0,0x3
ffffffffc02042bc:	9b850513          	addi	a0,a0,-1608 # ffffffffc0206c70 <default_pmm_manager+0x1040>
...
ffffffffc02042ca:	9d250513          	addi	a0,a0,-1582 # ffffffffc0206c98 <default_pmm_manager+0x1068>
ffffffffc02042ce:	ec1fb0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042d2:	00003517          	auipc	a0,0x3
ffffffffc02042d6:	9d650513          	addi	a0,a0,-1578 # ffffffffc0206ca8 <default_pmm_manager+0x1078>
ffffffffc02042da:	eb5fb0ef          	jal	ra,ffffffffc020018e <cprintf>
    return 0;
}
...
ffffffffc02042ea:	1101                	addi	sp,sp,-32
    if (proc != current) {
ffffffffc02042ec:	00012797          	auipc	a5,0x12
ffffffffc02042f0:	1bc78793          	addi	a5,a5,444 # ffffffffc02164a8 <current>
proc_run(struct proc_struct *proc) {
ffffffffc02042f4:	e426                	sd	s1,8(sp)
    if (proc != current) {
ffffffffc02042f6:	6384                	ld	s1,0(a5)
proc_run(struct proc_struct *proc) {
ffffffffc02042f8:	ec06                	sd	ra,24(sp)
ffffffffc02042fa:	e822                	sd	s0,16(sp)
ffffffffc02042fc:	e04a                	sd	s2,0(sp)
    if (proc != current) {
ffffffffc02042fe:	02a48c63          	beq	s1,a0,ffffffffc0204336 <proc_run+0x4c>
ffffffffc0204302:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204304:	100027f3          	csrr	a5,sstatus
ffffffffc0204308:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020430a:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020430c:	e3b1                	bnez	a5,ffffffffc0204350 <proc_run+0x66>
        lcr3(next->cr3);
ffffffffc020430e:	745c                	ld	a5,168(s0)
        current = proc;
ffffffffc0204310:	00012717          	auipc	a4,0x12
ffffffffc0204314:	18873c23          	sd	s0,408(a4) # ffffffffc02164a8 <current>
...
ffffffffc020431c:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc0204320:	8fd9                	or	a5,a5,a4
ffffffffc0204322:	18079073          	csrw	satp,a5
        switch_to(&(prev->context), &(next->context));
ffffffffc0204326:	03040593          	addi	a1,s0,48
ffffffffc020432a:	03048513          	addi	a0,s1,48
ffffffffc020432e:	58c000ef          	jal	ra,ffffffffc02048ba <switch_to>
    if (flag) {
ffffffffc0204332:	00091863          	bnez	s2,ffffffffc0204342 <proc_run+0x58>
}
ffffffffc0204336:	60e2                	ld	ra,24(sp)
ffffffffc0204338:	6442                	ld	s0,16(sp)
ffffffffc020433a:	64a2                	ld	s1,8(sp)
ffffffffc020433c:	6902                	ld	s2,0(sp)
ffffffffc020433e:	6105                	addi	sp,sp,32
ffffffffc0204340:	8082                	ret
ffffffffc0204342:	6442                	ld	s0,16(sp)
ffffffffc0204344:	60e2                	ld	ra,24(sp)
ffffffffc0204346:	64a2                	ld	s1,8(sp)
ffffffffc0204348:	6902                	ld	s2,0(sp)
ffffffffc020434a:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc020434c:	a86fc06f          	j	ffffffffc02005d2 <intr_enable>
        intr_disable();
ffffffffc0204350:	a88fc0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc0204354:	4905                	li	s2,1
ffffffffc0204356:	bf65                	j	ffffffffc020430e <proc_run+0x24>

ffffffffc0204358 <find_proc>:
    if (0 < pid && pid < MAX_PID) {
ffffffffc0204358:	0005071b          	sext.w	a4,a0
ffffffffc020435c:	6789                	lui	a5,0x2
ffffffffc020435e:	fff7069b          	addiw	a3,a4,-1
ffffffffc0204362:	17f9                	addi	a5,a5,-2
ffffffffc0204364:	04d7e063          	bltu	a5,a3,ffffffffc02043a4 <find_proc+0x4c>
find_proc(int pid) {
ffffffffc0204368:	1141                	addi	sp,sp,-16
ffffffffc020436a:	e022                	sd	s0,0(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020436c:	45a9                	li	a1,10
ffffffffc020436e:	842a                	mv	s0,a0
ffffffffc0204370:	853a                	mv	a0,a4
find_proc(int pid) {
ffffffffc0204372:	e406                	sd	ra,8(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204374:	67c000ef          	jal	ra,ffffffffc02049f0 <hash32>
ffffffffc0204378:	02051693          	slli	a3,a0,0x20
ffffffffc020437c:	82f1                	srli	a3,a3,0x1c
ffffffffc020437e:	0000e517          	auipc	a0,0xe
ffffffffc0204382:	0e250513          	addi	a0,a0,226 # ffffffffc0212460 <hash_list>
ffffffffc0204386:	96aa                	add	a3,a3,a0
ffffffffc0204388:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc020438a:	a029                	j	ffffffffc0204394 <find_proc+0x3c>
            if (proc->pid == pid) {
ffffffffc020438c:	f2c7a703          	lw	a4,-212(a5) # 1f2c <BASE_ADDRESS-0xffffffffc01fe0d4>
ffffffffc0204390:	00870c63          	beq	a4,s0,ffffffffc02043a8 <find_proc+0x50>
ffffffffc0204394:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204396:	fef69be3          	bne	a3,a5,ffffffffc020438c <find_proc+0x34>
}
ffffffffc020439a:	60a2                	ld	ra,8(sp)
ffffffffc020439c:	6402                	ld	s0,0(sp)
    return NULL;
...
ffffffffc02043a8:	60a2                	ld	ra,8(sp)
ffffffffc02043aa:	6402                	ld	s0,0(sp)
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02043ac:	f2878513          	addi	a0,a5,-216
}
ffffffffc02043b0:	0141                	addi	sp,sp,16
ffffffffc02043b2:	8082                	ret

ffffffffc02043b4 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc02043b4:	7179                	addi	sp,sp,-48
ffffffffc02043b6:	e84a                	sd	s2,16(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc02043b8:	00012917          	auipc	s2,0x12
ffffffffc02043bc:	10890913          	addi	s2,s2,264 # ffffffffc02164c0 <nr_process>
ffffffffc02043c0:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc02043c4:	f406                	sd	ra,40(sp)
ffffffffc02043c6:	f022                	sd	s0,32(sp)
ffffffffc02043c8:	ec26                	sd	s1,24(sp)
ffffffffc02043ca:	e44e                	sd	s3,8(sp)
ffffffffc02043cc:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc02043ce:	6785                	lui	a5,0x1
ffffffffc02043d0:	22f75763          	ble	a5,a4,ffffffffc02045fe <do_fork+0x24a>
ffffffffc02043d4:	89ae                	mv	s3,a1
ffffffffc02043d6:	84b2                	mv	s1,a2
    proc=alloc_proc();
ffffffffc02043d8:	df3ff0ef          	jal	ra,ffffffffc02041ca <alloc_proc>
ffffffffc02043dc:	842a                	mv	s0,a0
    if(proc==NULL){
ffffffffc02043de:	22050263          	beqz	a0,ffffffffc0204602 <do_fork+0x24e>
    proc->parent=current;
ffffffffc02043e2:	00012a17          	auipc	s4,0x12
ffffffffc02043e6:	0c6a0a13          	addi	s4,s4,198 # ffffffffc02164a8 <current>
ffffffffc02043ea:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043ee:	4509                	li	a0,2
    proc->parent=current;
ffffffffc02043f0:	f01c                	sd	a5,32(s0)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043f2:	fa4fd0ef          	jal	ra,ffffffffc0201b96 <alloc_pages>
    if (page != NULL) {
ffffffffc02043f6:	1e050f63          	beqz	a0,ffffffffc02045f4 <do_fork+0x240>
    return page - pages + nbase;
ffffffffc02043fa:	00012797          	auipc	a5,0x12
ffffffffc02043fe:	10678793          	addi	a5,a5,262 # ffffffffc0216500 <pages>
ffffffffc0204402:	6394                	ld	a3,0(a5)
ffffffffc0204404:	00003797          	auipc	a5,0x3
ffffffffc0204408:	c1c78793          	addi	a5,a5,-996 # ffffffffc0207020 <nbase>
    return KADDR(page2pa(page));
ffffffffc020440c:	00012717          	auipc	a4,0x12
ffffffffc0204410:	08470713          	addi	a4,a4,132 # ffffffffc0216490 <npage>
    return page - pages + nbase;
ffffffffc0204414:	40d506b3          	sub	a3,a0,a3
ffffffffc0204418:	6388                	ld	a0,0(a5)
ffffffffc020441a:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc020441c:	57fd                	li	a5,-1
ffffffffc020441e:	6318                	ld	a4,0(a4)
    return page - pages + nbase;
ffffffffc0204420:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc0204422:	83b1                	srli	a5,a5,0xc
ffffffffc0204424:	8ff5                	and	a5,a5,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204426:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204428:	1ee7ff63          	bleu	a4,a5,ffffffffc0204626 <do_fork+0x272>
    assert(current->mm == NULL);
ffffffffc020442c:	000a3783          	ld	a5,0(s4)
ffffffffc0204430:	00012717          	auipc	a4,0x12
ffffffffc0204434:	0c070713          	addi	a4,a4,192 # ffffffffc02164f0 <va_pa_offset>
ffffffffc0204438:	6318                	ld	a4,0(a4)
ffffffffc020443a:	779c                	ld	a5,40(a5)
ffffffffc020443c:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc020443e:	e814                	sd	a3,16(s0)
    assert(current->mm == NULL);
ffffffffc0204440:	1c079363          	bnez	a5,ffffffffc0204606 <do_fork+0x252>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204444:	6789                	lui	a5,0x2
ffffffffc0204446:	ee078793          	addi	a5,a5,-288 # 1ee0 <BASE_ADDRESS-0xffffffffc01fe120>
ffffffffc020444a:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc020444c:	8626                	mv	a2,s1
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc020444e:	f054                	sd	a3,160(s0)
    *(proc->tf) = *tf;
ffffffffc0204450:	87b6                	mv	a5,a3
ffffffffc0204452:	12048893          	addi	a7,s1,288
ffffffffc0204456:	00063803          	ld	a6,0(a2)
ffffffffc020445a:	6608                	ld	a0,8(a2)
ffffffffc020445c:	6a0c                	ld	a1,16(a2)
ffffffffc020445e:	6e18                	ld	a4,24(a2)
ffffffffc0204460:	0107b023          	sd	a6,0(a5)
ffffffffc0204464:	e788                	sd	a0,8(a5)
ffffffffc0204466:	eb8c                	sd	a1,16(a5)
ffffffffc0204468:	ef98                	sd	a4,24(a5)
ffffffffc020446a:	02060613          	addi	a2,a2,32
ffffffffc020446e:	02078793          	addi	a5,a5,32
ffffffffc0204472:	ff1612e3          	bne	a2,a7,ffffffffc0204456 <do_fork+0xa2>
    proc->tf->gpr.a0 = 0;
ffffffffc0204476:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020447a:	10098e63          	beqz	s3,ffffffffc0204596 <do_fork+0x1e2>
ffffffffc020447e:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204482:	00000797          	auipc	a5,0x0
ffffffffc0204486:	dac78793          	addi	a5,a5,-596 # ffffffffc020422e <forkret>
ffffffffc020448a:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020448c:	fc14                	sd	a3,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020448e:	100027f3          	csrr	a5,sstatus
ffffffffc0204492:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204494:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204496:	10079f63          	bnez	a5,ffffffffc02045b4 <do_fork+0x200>
    if (++ last_pid >= MAX_PID) {
ffffffffc020449a:	00007797          	auipc	a5,0x7
ffffffffc020449e:	bbe78793          	addi	a5,a5,-1090 # ffffffffc020b058 <last_pid.1575>
ffffffffc02044a2:	439c                	lw	a5,0(a5)
ffffffffc02044a4:	6709                	lui	a4,0x2
ffffffffc02044a6:	0017851b          	addiw	a0,a5,1
ffffffffc02044aa:	00007697          	auipc	a3,0x7
ffffffffc02044ae:	baa6a723          	sw	a0,-1106(a3) # ffffffffc020b058 <last_pid.1575>
ffffffffc02044b2:	12e55263          	ble	a4,a0,ffffffffc02045d6 <do_fork+0x222>
    if (last_pid >= next_safe) {
ffffffffc02044b6:	00007797          	auipc	a5,0x7
ffffffffc02044ba:	ba678793          	addi	a5,a5,-1114 # ffffffffc020b05c <next_safe.1574>
...
ffffffffc02044c8:	06f54063          	blt	a0,a5,ffffffffc0204528 <do_fork+0x174>
        next_safe = MAX_PID;
ffffffffc02044cc:	6789                	lui	a5,0x2
ffffffffc02044ce:	00007717          	auipc	a4,0x7
ffffffffc02044d2:	b8f72723          	sw	a5,-1138(a4) # ffffffffc020b05c <next_safe.1574>
ffffffffc02044d6:	4581                	li	a1,0
ffffffffc02044d8:	87aa                	mv	a5,a0
ffffffffc02044da:	00012497          	auipc	s1,0x12
ffffffffc02044de:	10e48493          	addi	s1,s1,270 # ffffffffc02165e8 <proc_list>
    repeat:
ffffffffc02044e2:	6889                	lui	a7,0x2
ffffffffc02044e4:	882e                	mv	a6,a1
ffffffffc02044e6:	6609                	lui	a2,0x2
        le = list;
ffffffffc02044e8:	00012697          	auipc	a3,0x12
ffffffffc02044ec:	10068693          	addi	a3,a3,256 # ffffffffc02165e8 <proc_list>
ffffffffc02044f0:	6694                	ld	a3,8(a3)
        while ((le = list_next(le)) != list) {
ffffffffc02044f2:	00968f63          	beq	a3,s1,ffffffffc0204510 <do_fork+0x15c>
            if (proc->pid == last_pid) {
ffffffffc02044f6:	f3c6a703          	lw	a4,-196(a3)
ffffffffc02044fa:	08e78963          	beq	a5,a4,ffffffffc020458c <do_fork+0x1d8>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044fe:	fee7d9e3          	ble	a4,a5,ffffffffc02044f0 <do_fork+0x13c>
ffffffffc0204502:	fec757e3          	ble	a2,a4,ffffffffc02044f0 <do_fork+0x13c>
ffffffffc0204506:	6694                	ld	a3,8(a3)
ffffffffc0204508:	863a                	mv	a2,a4
ffffffffc020450a:	4805                	li	a6,1
        while ((le = list_next(le)) != list) {
ffffffffc020450c:	fe9695e3          	bne	a3,s1,ffffffffc02044f6 <do_fork+0x142>
ffffffffc0204510:	c591                	beqz	a1,ffffffffc020451c <do_fork+0x168>
ffffffffc0204512:	00007717          	auipc	a4,0x7
ffffffffc0204516:	b4f72323          	sw	a5,-1210(a4) # ffffffffc020b058 <last_pid.1575>
ffffffffc020451a:	853e                	mv	a0,a5
ffffffffc020451c:	00080663          	beqz	a6,ffffffffc0204528 <do_fork+0x174>
ffffffffc0204520:	00007797          	auipc	a5,0x7
ffffffffc0204524:	b2c7ae23          	sw	a2,-1220(a5) # ffffffffc020b05c <next_safe.1574>
        proc->pid=get_pid();
ffffffffc0204528:	c048                	sw	a0,4(s0)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020452a:	45a9                	li	a1,10
ffffffffc020452c:	2501                	sext.w	a0,a0
ffffffffc020452e:	4c2000ef          	jal	ra,ffffffffc02049f0 <hash32>
ffffffffc0204532:	1502                	slli	a0,a0,0x20
ffffffffc0204534:	0000e797          	auipc	a5,0xe
ffffffffc0204538:	f2c78793          	addi	a5,a5,-212 # ffffffffc0212460 <hash_list>
ffffffffc020453c:	8171                	srli	a0,a0,0x1c
ffffffffc020453e:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204540:	6510                	ld	a2,8(a0)
ffffffffc0204542:	0d840793          	addi	a5,s0,216
ffffffffc0204546:	6494                	ld	a3,8(s1)
        nr_process++;
ffffffffc0204548:	00092703          	lw	a4,0(s2)
    prev->next = next->prev = elm;
ffffffffc020454c:	e21c                	sd	a5,0(a2)
ffffffffc020454e:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc0204550:	f070                	sd	a2,224(s0)
        list_add(&proc_list,&(proc->list_link));
ffffffffc0204552:	0c840793          	addi	a5,s0,200
    elm->prev = prev;
ffffffffc0204556:	ec68                	sd	a0,216(s0)
    prev->next = next->prev = elm;
ffffffffc0204558:	e29c                	sd	a5,0(a3)
        nr_process++;
ffffffffc020455a:	2705                	addiw	a4,a4,1
ffffffffc020455c:	00012617          	auipc	a2,0x12
ffffffffc0204560:	08f63a23          	sd	a5,148(a2) # ffffffffc02165f0 <proc_list+0x8>
    elm->next = next;
ffffffffc0204564:	e874                	sd	a3,208(s0)
    elm->prev = prev;
ffffffffc0204566:	e464                	sd	s1,200(s0)
ffffffffc0204568:	00012797          	auipc	a5,0x12
ffffffffc020456c:	f4e7ac23          	sw	a4,-168(a5) # ffffffffc02164c0 <nr_process>
    if (flag) {
ffffffffc0204570:	06099a63          	bnez	s3,ffffffffc02045e4 <do_fork+0x230>
    wakeup_proc(proc);
ffffffffc0204574:	8522                	mv	a0,s0
ffffffffc0204576:	3ae000ef          	jal	ra,ffffffffc0204924 <wakeup_proc>
    ret=proc->pid;
ffffffffc020457a:	4048                	lw	a0,4(s0)
}
ffffffffc020457c:	70a2                	ld	ra,40(sp)
ffffffffc020457e:	7402                	ld	s0,32(sp)
ffffffffc0204580:	64e2                	ld	s1,24(sp)
ffffffffc0204582:	6942                	ld	s2,16(sp)
ffffffffc0204584:	69a2                	ld	s3,8(sp)
ffffffffc0204586:	6a02                	ld	s4,0(sp)
ffffffffc0204588:	6145                	addi	sp,sp,48
ffffffffc020458a:	8082                	ret
                if (++ last_pid >= next_safe) {
ffffffffc020458c:	2785                	addiw	a5,a5,1
ffffffffc020458e:	04c7de63          	ble	a2,a5,ffffffffc02045ea <do_fork+0x236>
ffffffffc0204592:	4585                	li	a1,1
ffffffffc0204594:	bfb1                	j	ffffffffc02044f0 <do_fork+0x13c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204596:	89b6                	mv	s3,a3
ffffffffc0204598:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020459c:	00000797          	auipc	a5,0x0
ffffffffc02045a0:	c9278793          	addi	a5,a5,-878 # ffffffffc020422e <forkret>
ffffffffc02045a4:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc02045a6:	fc14                	sd	a3,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02045a8:	100027f3          	csrr	a5,sstatus
ffffffffc02045ac:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02045ae:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02045b0:	ee0785e3          	beqz	a5,ffffffffc020449a <do_fork+0xe6>
        intr_disable();
ffffffffc02045b4:	824fc0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
    if (++ last_pid >= MAX_PID) {
ffffffffc02045b8:	00007797          	auipc	a5,0x7
ffffffffc02045bc:	aa078793          	addi	a5,a5,-1376 # ffffffffc020b058 <last_pid.1575>
ffffffffc02045c0:	439c                	lw	a5,0(a5)
ffffffffc02045c2:	6709                	lui	a4,0x2
        return 1;
ffffffffc02045c4:	4985                	li	s3,1
ffffffffc02045c6:	0017851b          	addiw	a0,a5,1
ffffffffc02045ca:	00007697          	auipc	a3,0x7
ffffffffc02045ce:	a8a6a723          	sw	a0,-1394(a3) # ffffffffc020b058 <last_pid.1575>
ffffffffc02045d2:	eee542e3          	blt	a0,a4,ffffffffc02044b6 <do_fork+0x102>
        last_pid = 1;
ffffffffc02045d6:	4785                	li	a5,1
ffffffffc02045d8:	00007717          	auipc	a4,0x7
ffffffffc02045dc:	a8f72023          	sw	a5,-1408(a4) # ffffffffc020b058 <last_pid.1575>
ffffffffc02045e0:	4505                	li	a0,1
ffffffffc02045e2:	b5ed                	j	ffffffffc02044cc <do_fork+0x118>
        intr_enable();
ffffffffc02045e4:	feffb0ef          	jal	ra,ffffffffc02005d2 <intr_enable>
ffffffffc02045e8:	b771                	j	ffffffffc0204574 <do_fork+0x1c0>
                    if (last_pid >= MAX_PID) {
ffffffffc02045ea:	0117c363          	blt	a5,a7,ffffffffc02045f0 <do_fork+0x23c>
                        last_pid = 1;
ffffffffc02045ee:	4785                	li	a5,1
                    goto repeat;
ffffffffc02045f0:	4585                	li	a1,1
ffffffffc02045f2:	bdcd                	j	ffffffffc02044e4 <do_fork+0x130>
    kfree(proc);
ffffffffc02045f4:	8522                	mv	a0,s0
ffffffffc02045f6:	c60fd0ef          	jal	ra,ffffffffc0201a56 <kfree>
    ret = -E_NO_MEM;
ffffffffc02045fa:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045fc:	b741                	j	ffffffffc020457c <do_fork+0x1c8>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045fe:	556d                	li	a0,-5
ffffffffc0204600:	bfb5                	j	ffffffffc020457c <do_fork+0x1c8>
    ret = -E_NO_MEM;
ffffffffc0204602:	5571                	li	a0,-4
ffffffffc0204604:	bfa5                	j	ffffffffc020457c <do_fork+0x1c8>
    assert(current->mm == NULL);
ffffffffc0204606:	00002697          	auipc	a3,0x2
ffffffffc020460a:	63a68693          	addi	a3,a3,1594 # ffffffffc0206c40 <default_pmm_manager+0x1010>
ffffffffc020460e:	00001617          	auipc	a2,0x1
ffffffffc0204612:	28a60613          	addi	a2,a2,650 # ffffffffc0205898 <commands+0x870>
ffffffffc0204616:	10900593          	li	a1,265
ffffffffc020461a:	00002517          	auipc	a0,0x2
ffffffffc020461e:	63e50513          	addi	a0,a0,1598 # ffffffffc0206c58 <default_pmm_manager+0x1028>
ffffffffc0204622:	e2ffb0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc0204626:	00001617          	auipc	a2,0x1
ffffffffc020462a:	65a60613          	addi	a2,a2,1626 # ffffffffc0205c80 <default_pmm_manager+0x50>
ffffffffc020462e:	06900593          	li	a1,105
ffffffffc0204632:	00001517          	auipc	a0,0x1
ffffffffc0204636:	67650513          	addi	a0,a0,1654 # ffffffffc0205ca8 <default_pmm_manager+0x78>
ffffffffc020463a:	e17fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020463e <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020463e:	7129                	addi	sp,sp,-320
ffffffffc0204640:	fa22                	sd	s0,304(sp)
ffffffffc0204642:	f626                	sd	s1,296(sp)
ffffffffc0204644:	f24a                	sd	s2,288(sp)
ffffffffc0204646:	84ae                	mv	s1,a1
ffffffffc0204648:	892a                	mv	s2,a0
ffffffffc020464a:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020464c:	4581                	li	a1,0
ffffffffc020464e:	12000613          	li	a2,288
ffffffffc0204652:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204654:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204656:	049000ef          	jal	ra,ffffffffc0204e9e <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc020465a:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc020465c:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc020465e:	100027f3          	csrr	a5,sstatus
ffffffffc0204662:	edd7f793          	andi	a5,a5,-291
ffffffffc0204666:	1207e793          	ori	a5,a5,288
ffffffffc020466a:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020466c:	860a                	mv	a2,sp
ffffffffc020466e:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204672:	00000797          	auipc	a5,0x0
ffffffffc0204676:	b5078793          	addi	a5,a5,-1200 # ffffffffc02041c2 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020467a:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020467c:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020467e:	d37ff0ef          	jal	ra,ffffffffc02043b4 <do_fork>
}
ffffffffc0204682:	70f2                	ld	ra,312(sp)
ffffffffc0204684:	7452                	ld	s0,304(sp)
ffffffffc0204686:	74b2                	ld	s1,296(sp)
ffffffffc0204688:	7912                	ld	s2,288(sp)
ffffffffc020468a:	6131                	addi	sp,sp,320
ffffffffc020468c:	8082                	ret

ffffffffc020468e <do_exit>:
do_exit(int error_code) {
ffffffffc020468e:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc0204690:	00002617          	auipc	a2,0x2
ffffffffc0204694:	59860613          	addi	a2,a2,1432 # ffffffffc0206c28 <default_pmm_manager+0xff8>
ffffffffc0204698:	17300593          	li	a1,371
ffffffffc020469c:	00002517          	auipc	a0,0x2
ffffffffc02046a0:	5bc50513          	addi	a0,a0,1468 # ffffffffc0206c58 <default_pmm_manager+0x1028>
do_exit(int error_code) {
ffffffffc02046a4:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046a6:	dabfb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02046aa <proc_init>:
    elm->prev = elm->next = elm;
ffffffffc02046aa:	00012797          	auipc	a5,0x12
ffffffffc02046ae:	f3e78793          	addi	a5,a5,-194 # ffffffffc02165e8 <proc_list>

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc02046b2:	1101                	addi	sp,sp,-32
ffffffffc02046b4:	00012717          	auipc	a4,0x12
ffffffffc02046b8:	f2f73e23          	sd	a5,-196(a4) # ffffffffc02165f0 <proc_list+0x8>
ffffffffc02046bc:	00012717          	auipc	a4,0x12
ffffffffc02046c0:	f2f73623          	sd	a5,-212(a4) # ffffffffc02165e8 <proc_list>
ffffffffc02046c4:	ec06                	sd	ra,24(sp)
ffffffffc02046c6:	e822                	sd	s0,16(sp)
ffffffffc02046c8:	e426                	sd	s1,8(sp)
ffffffffc02046ca:	e04a                	sd	s2,0(sp)
ffffffffc02046cc:	0000e797          	auipc	a5,0xe
ffffffffc02046d0:	d9478793          	addi	a5,a5,-620 # ffffffffc0212460 <hash_list>
ffffffffc02046d4:	00012717          	auipc	a4,0x12
ffffffffc02046d8:	d8c70713          	addi	a4,a4,-628 # ffffffffc0216460 <name.1565>
ffffffffc02046dc:	e79c                	sd	a5,8(a5)
ffffffffc02046de:	e39c                	sd	a5,0(a5)
ffffffffc02046e0:	07c1                	addi	a5,a5,16
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc02046e2:	fee79de3          	bne	a5,a4,ffffffffc02046dc <proc_init+0x32>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02046e6:	ae5ff0ef          	jal	ra,ffffffffc02041ca <alloc_proc>
ffffffffc02046ea:	00012797          	auipc	a5,0x12
ffffffffc02046ee:	dca7b323          	sd	a0,-570(a5) # ffffffffc02164b0 <idleproc>
ffffffffc02046f2:	00012417          	auipc	s0,0x12
ffffffffc02046f6:	dbe40413          	addi	s0,s0,-578 # ffffffffc02164b0 <idleproc>
ffffffffc02046fa:	12050a63          	beqz	a0,ffffffffc020482e <proc_init+0x184>
...
ffffffffc0204702:	a98fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204706:	07000613          	li	a2,112
ffffffffc020470a:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020470c:	84aa                	mv	s1,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020470e:	790000ef          	jal	ra,ffffffffc0204e9e <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204712:	6008                	ld	a0,0(s0)
ffffffffc0204714:	85a6                	mv	a1,s1
ffffffffc0204716:	07000613          	li	a2,112
ffffffffc020471a:	03050513          	addi	a0,a0,48
ffffffffc020471e:	7aa000ef          	jal	ra,ffffffffc0204ec8 <memcmp>
ffffffffc0204722:	892a                	mv	s2,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204724:	453d                	li	a0,15
ffffffffc0204726:	a74fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020472a:	463d                	li	a2,15
ffffffffc020472c:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc020472e:	84aa                	mv	s1,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204730:	76e000ef          	jal	ra,ffffffffc0204e9e <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204734:	6008                	ld	a0,0(s0)
ffffffffc0204736:	463d                	li	a2,15
ffffffffc0204738:	85a6                	mv	a1,s1
ffffffffc020473a:	0b450513          	addi	a0,a0,180
ffffffffc020473e:	78a000ef          	jal	ra,ffffffffc0204ec8 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204742:	601c                	ld	a5,0(s0)
ffffffffc0204744:	00012717          	auipc	a4,0x12
ffffffffc0204748:	db470713          	addi	a4,a4,-588 # ffffffffc02164f8 <boot_cr3>
ffffffffc020474c:	6318                	ld	a4,0(a4)
ffffffffc020474e:	77d4                	ld	a3,168(a5)
ffffffffc0204750:	08e68e63          	beq	a3,a4,ffffffffc02047ec <proc_init+0x142>
...
ffffffffc0204754:	4709                	li	a4,2
ffffffffc0204756:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204758:	00004717          	auipc	a4,0x4
ffffffffc020475c:	8a870713          	addi	a4,a4,-1880 # ffffffffc0208000 <bootstack>
...
ffffffffc020476a:	59258593          	addi	a1,a1,1426 # ffffffffc0206cf8 <default_pmm_manager+0x10c8>
ffffffffc020476e:	853e                	mv	a0,a5
ffffffffc0204770:	acfff0ef          	jal	ra,ffffffffc020423e <set_proc_name>
    nr_process ++;
ffffffffc0204774:	00012797          	auipc	a5,0x12
ffffffffc0204778:	d4c78793          	addi	a5,a5,-692 # ffffffffc02164c0 <nr_process>
ffffffffc020477c:	439c                	lw	a5,0(a5)
...
ffffffffc0204788:	57c58593          	addi	a1,a1,1404 # ffffffffc0206d00 <default_pmm_manager+0x10d0>
ffffffffc020478c:	00000517          	auipc	a0,0x0
ffffffffc0204790:	b0c50513          	addi	a0,a0,-1268 # ffffffffc0204298 <init_main>
    nr_process ++;
ffffffffc0204794:	00012697          	auipc	a3,0x12
ffffffffc0204798:	d2f6a623          	sw	a5,-724(a3) # ffffffffc02164c0 <nr_process>
    current = idleproc;
ffffffffc020479c:	00012797          	auipc	a5,0x12
ffffffffc02047a0:	d0e7b623          	sd	a4,-756(a5) # ffffffffc02164a8 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047a4:	e9bff0ef          	jal	ra,ffffffffc020463e <kernel_thread>
    if (pid <= 0) {
ffffffffc02047a8:	0ca05f63          	blez	a0,ffffffffc0204886 <proc_init+0x1dc>
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc02047ac:	badff0ef          	jal	ra,ffffffffc0204358 <find_proc>
    set_proc_name(initproc, "init");
ffffffffc02047b0:	00002597          	auipc	a1,0x2
ffffffffc02047b4:	58058593          	addi	a1,a1,1408 # ffffffffc0206d30 <default_pmm_manager+0x1100>
    initproc = find_proc(pid);
ffffffffc02047b8:	00012797          	auipc	a5,0x12
ffffffffc02047bc:	d0a7b023          	sd	a0,-768(a5) # ffffffffc02164b8 <initproc>
    set_proc_name(initproc, "init");
ffffffffc02047c0:	a7fff0ef          	jal	ra,ffffffffc020423e <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02047c4:	601c                	ld	a5,0(s0)
ffffffffc02047c6:	c3c5                	beqz	a5,ffffffffc0204866 <proc_init+0x1bc>
ffffffffc02047c8:	43dc                	lw	a5,4(a5)
ffffffffc02047ca:	efd1                	bnez	a5,ffffffffc0204866 <proc_init+0x1bc>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02047cc:	00012797          	auipc	a5,0x12
ffffffffc02047d0:	cec78793          	addi	a5,a5,-788 # ffffffffc02164b8 <initproc>
ffffffffc02047d4:	639c                	ld	a5,0(a5)
ffffffffc02047d6:	cba5                	beqz	a5,ffffffffc0204846 <proc_init+0x19c>
ffffffffc02047d8:	43d8                	lw	a4,4(a5)
ffffffffc02047da:	4785                	li	a5,1
ffffffffc02047dc:	06f71563          	bne	a4,a5,ffffffffc0204846 <proc_init+0x19c>
}
...
ffffffffc02047ee:	f33d                	bnez	a4,ffffffffc0204754 <proc_init+0xaa>
ffffffffc02047f0:	f60912e3          	bnez	s2,ffffffffc0204754 <proc_init+0xaa>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc02047f4:	6394                	ld	a3,0(a5)
ffffffffc02047f6:	577d                	li	a4,-1
ffffffffc02047f8:	1702                	slli	a4,a4,0x20
ffffffffc02047fa:	f4e69de3          	bne	a3,a4,ffffffffc0204754 <proc_init+0xaa>
ffffffffc02047fe:	4798                	lw	a4,8(a5)
ffffffffc0204800:	fb31                	bnez	a4,ffffffffc0204754 <proc_init+0xaa>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204802:	6b98                	ld	a4,16(a5)
ffffffffc0204804:	fb21                	bnez	a4,ffffffffc0204754 <proc_init+0xaa>
ffffffffc0204806:	4f98                	lw	a4,24(a5)
ffffffffc0204808:	2701                	sext.w	a4,a4
ffffffffc020480a:	f729                	bnez	a4,ffffffffc0204754 <proc_init+0xaa>
ffffffffc020480c:	7398                	ld	a4,32(a5)
ffffffffc020480e:	f339                	bnez	a4,ffffffffc0204754 <proc_init+0xaa>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204810:	7798                	ld	a4,40(a5)
ffffffffc0204812:	f329                	bnez	a4,ffffffffc0204754 <proc_init+0xaa>
ffffffffc0204814:	0b07a703          	lw	a4,176(a5)
ffffffffc0204818:	8f49                	or	a4,a4,a0
ffffffffc020481a:	2701                	sext.w	a4,a4
ffffffffc020481c:	ff05                	bnez	a4,ffffffffc0204754 <proc_init+0xaa>
        cprintf("alloc_proc() correct!\n");
ffffffffc020481e:	00002517          	auipc	a0,0x2
ffffffffc0204822:	4c250513          	addi	a0,a0,1218 # ffffffffc0206ce0 <default_pmm_manager+0x10b0>
ffffffffc0204826:	969fb0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc020482a:	601c                	ld	a5,0(s0)
ffffffffc020482c:	b725                	j	ffffffffc0204754 <proc_init+0xaa>
        panic("cannot alloc idleproc.\n");
ffffffffc020482e:	00002617          	auipc	a2,0x2
ffffffffc0204832:	49a60613          	addi	a2,a2,1178 # ffffffffc0206cc8 <default_pmm_manager+0x1098>
ffffffffc0204836:	18b00593          	li	a1,395
ffffffffc020483a:	00002517          	auipc	a0,0x2
ffffffffc020483e:	41e50513          	addi	a0,a0,1054 # ffffffffc0206c58 <default_pmm_manager+0x1028>
ffffffffc0204842:	c0ffb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204846:	00002697          	auipc	a3,0x2
ffffffffc020484a:	51a68693          	addi	a3,a3,1306 # ffffffffc0206d60 <default_pmm_manager+0x1130>
ffffffffc020484e:	00001617          	auipc	a2,0x1
ffffffffc0204852:	04a60613          	addi	a2,a2,74 # ffffffffc0205898 <commands+0x870>
ffffffffc0204856:	1b200593          	li	a1,434
ffffffffc020485a:	00002517          	auipc	a0,0x2
ffffffffc020485e:	3fe50513          	addi	a0,a0,1022 # ffffffffc0206c58 <default_pmm_manager+0x1028>
ffffffffc0204862:	beffb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204866:	00002697          	auipc	a3,0x2
ffffffffc020486a:	4d268693          	addi	a3,a3,1234 # ffffffffc0206d38 <default_pmm_manager+0x1108>
ffffffffc020486e:	00001617          	auipc	a2,0x1
ffffffffc0204872:	02a60613          	addi	a2,a2,42 # ffffffffc0205898 <commands+0x870>
ffffffffc0204876:	1b100593          	li	a1,433
ffffffffc020487a:	00002517          	auipc	a0,0x2
ffffffffc020487e:	3de50513          	addi	a0,a0,990 # ffffffffc0206c58 <default_pmm_manager+0x1028>
ffffffffc0204882:	bcffb0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204886:	00002617          	auipc	a2,0x2
ffffffffc020488a:	48a60613          	addi	a2,a2,1162 # ffffffffc0206d10 <default_pmm_manager+0x10e0>
ffffffffc020488e:	1ab00593          	li	a1,427
ffffffffc0204892:	00002517          	auipc	a0,0x2
ffffffffc0204896:	3c650513          	addi	a0,a0,966 # ffffffffc0206c58 <default_pmm_manager+0x1028>
ffffffffc020489a:	bb7fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020489e <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc020489e:	1141                	addi	sp,sp,-16
ffffffffc02048a0:	e022                	sd	s0,0(sp)
ffffffffc02048a2:	e406                	sd	ra,8(sp)
ffffffffc02048a4:	00012417          	auipc	s0,0x12
ffffffffc02048a8:	c0440413          	addi	s0,s0,-1020 # ffffffffc02164a8 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc02048ac:	6018                	ld	a4,0(s0)
ffffffffc02048ae:	4f1c                	lw	a5,24(a4)
ffffffffc02048b0:	2781                	sext.w	a5,a5
ffffffffc02048b2:	dff5                	beqz	a5,ffffffffc02048ae <cpu_idle+0x10>
            schedule();
ffffffffc02048b4:	0a2000ef          	jal	ra,ffffffffc0204956 <schedule>
ffffffffc02048b8:	bfd5                	j	ffffffffc02048ac <cpu_idle+0xe>
...
ffffffffc020492a:	00f77563          	bleu	a5,a4,ffffffffc0204934 <wakeup_proc+0x10>
...
ffffffffc020493a:	45268693          	addi	a3,a3,1106 # ffffffffc0206d88 <default_pmm_manager+0x1158>
ffffffffc020493e:	00001617          	auipc	a2,0x1
ffffffffc0204942:	f5a60613          	addi	a2,a2,-166 # ffffffffc0205898 <commands+0x870>
ffffffffc0204946:	45a5                	li	a1,9
ffffffffc0204948:	00002517          	auipc	a0,0x2
ffffffffc020494c:	48050513          	addi	a0,a0,1152 # ffffffffc0206dc8 <default_pmm_manager+0x1198>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204950:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204952:	afffb0ef          	jal	ra,ffffffffc0200450 <__panic>
...
ffffffffc0204964:	e3d1                	bnez	a5,ffffffffc02049e8 <schedule+0x92>
    bool intr_flag;
...
ffffffffc0204966:	00012797          	auipc	a5,0x12
ffffffffc020496a:	b4278793          	addi	a5,a5,-1214 # ffffffffc02164a8 <current>
ffffffffc020496e:	0007b883          	ld	a7,0(a5)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204972:	00012797          	auipc	a5,0x12
ffffffffc0204976:	b3e78793          	addi	a5,a5,-1218 # ffffffffc02164b0 <idleproc>
ffffffffc020497a:	6388                	ld	a0,0(a5)
        current->need_resched = 0;
ffffffffc020497c:	0008ac23          	sw	zero,24(a7) # 2018 <BASE_ADDRESS-0xffffffffc01fdfe8>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204980:	04a88e63          	beq	a7,a0,ffffffffc02049dc <schedule+0x86>
ffffffffc0204984:	0c888693          	addi	a3,a7,200
ffffffffc0204988:	00012617          	auipc	a2,0x12
ffffffffc020498c:	c6060613          	addi	a2,a2,-928 # ffffffffc02165e8 <proc_list>
        le = last;
...
ffffffffc0204996:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204998:	00c78863          	beq	a5,a2,ffffffffc02049a8 <schedule+0x52>
                if (next->state == PROC_RUNNABLE) {
ffffffffc020499c:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049a0:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049a4:	01070463          	beq	a4,a6,ffffffffc02049ac <schedule+0x56>
                    break;
                }
            }
        } while (le != last);
ffffffffc02049a8:	fef697e3          	bne	a3,a5,ffffffffc0204996 <schedule+0x40>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049ac:	c589                	beqz	a1,ffffffffc02049b6 <schedule+0x60>
ffffffffc02049ae:	4198                	lw	a4,0(a1)
ffffffffc02049b0:	4789                	li	a5,2
ffffffffc02049b2:	00f70e63          	beq	a4,a5,ffffffffc02049ce <schedule+0x78>
            next = idleproc;
        }
        next->runs ++;
...
ffffffffc02049ba:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02049bc:	00a88463          	beq	a7,a0,ffffffffc02049c4 <schedule+0x6e>
            proc_run(next);
ffffffffc02049c0:	92bff0ef          	jal	ra,ffffffffc02042ea <proc_run>
    if (flag) {
ffffffffc02049c4:	e419                	bnez	s0,ffffffffc02049d2 <schedule+0x7c>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc02049d0:	b7dd                	j	ffffffffc02049b6 <schedule+0x60>
}
ffffffffc02049d2:	6402                	ld	s0,0(sp)
ffffffffc02049d4:	60a2                	ld	ra,8(sp)
ffffffffc02049d6:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049d8:	bfbfb06f          	j	ffffffffc02005d2 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049dc:	00012617          	auipc	a2,0x12
ffffffffc02049e0:	c0c60613          	addi	a2,a2,-1012 # ffffffffc02165e8 <proc_list>
ffffffffc02049e4:	86b2                	mv	a3,a2
ffffffffc02049e6:	b76d                	j	ffffffffc0204990 <schedule+0x3a>
        intr_disable();
ffffffffc02049e8:	bf1fb0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc02049ec:	4405                	li	s0,1
ffffffffc02049ee:	bfa5                	j	ffffffffc0204966 <schedule+0x10>
...
ffffffffc02049f6:	02f5053b          	mulw	a0,a0,a5
    return (hash >> (32 - bits));
ffffffffc02049fa:	02000793          	li	a5,32
ffffffffc02049fe:	40b785bb          	subw	a1,a5,a1
}
ffffffffc0204a02:	00b5553b          	srlw	a0,a0,a1
ffffffffc0204a06:	8082                	ret

ffffffffc0204a08 <printnum>:
 * */
static void
...
ffffffffc0204a08:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a0c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a0e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a12:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a14:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a18:	f022                	sd	s0,32(sp)
ffffffffc0204a1a:	ec26                	sd	s1,24(sp)
ffffffffc0204a1c:	e84a                	sd	s2,16(sp)
ffffffffc0204a1e:	f406                	sd	ra,40(sp)
...
ffffffffc0204a2a:	2a01                	sext.w	s4,s4
    ...
    if (num >= base) {
ffffffffc0204a2c:	03067e63          	bleu	a6,a2,ffffffffc0204a68 <printnum+0x60>
ffffffffc0204a30:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc0204a32:	00805763          	blez	s0,ffffffffc0204a40 <printnum+0x38>
ffffffffc0204a36:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a38:	85ca                	mv	a1,s2
ffffffffc0204a3a:	854e                	mv	a0,s3
ffffffffc0204a3c:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a3e:	fc65                	bnez	s0,ffffffffc0204a36 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a40:	1a02                	slli	s4,s4,0x20
ffffffffc0204a42:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a46:	00002797          	auipc	a5,0x2
ffffffffc0204a4a:	52a78793          	addi	a5,a5,1322 # ffffffffc0206f70 <error_string+0x38>
ffffffffc0204a4e:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a50:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a52:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a56:	70a2                	ld	ra,40(sp)
ffffffffc0204a58:	69a2                	ld	s3,8(sp)
ffffffffc0204a5a:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a5c:	85ca                	mv	a1,s2
ffffffffc0204a5e:	8326                	mv	t1,s1
}
ffffffffc0204a60:	6942                	ld	s2,16(sp)
ffffffffc0204a62:	64e2                	ld	s1,24(sp)
ffffffffc0204a64:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a66:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a68:	03065633          	divu	a2,a2,a6
ffffffffc0204a6c:	8722                	mv	a4,s0
ffffffffc0204a6e:	f9bff0ef          	jal	ra,ffffffffc0204a08 <printnum>
ffffffffc0204a72:	b7f9                	j	ffffffffc0204a40 <printnum+0x38>

ffffffffc0204a74 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a74:	7119                	addi	sp,sp,-128
ffffffffc0204a76:	f4a6                	sd	s1,104(sp)
ffffffffc0204a78:	f0ca                	sd	s2,96(sp)
...
ffffffffc0204a82:	f862                	sd	s8,48(sp)
ffffffffc0204a84:	f06a                	sd	s10,32(sp)
ffffffffc0204a86:	fc86                	sd	ra,120(sp)
ffffffffc0204a88:	f8a2                	sd	s0,112(sp)
ffffffffc0204a8a:	ecce                	sd	s3,88(sp)
ffffffffc0204a8c:	f466                	sd	s9,40(sp)
ffffffffc0204a8e:	ec6e                	sd	s11,24(sp)
ffffffffc0204a90:	892a                	mv	s2,a0
ffffffffc0204a92:	84ae                	mv	s1,a1
ffffffffc0204a94:	8d32                	mv	s10,a2
ffffffffc0204a96:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204a98:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a9a:	00002a17          	auipc	s4,0x2
ffffffffc0204a9e:	346a0a13          	addi	s4,s4,838 # ffffffffc0206de0 <default_pmm_manager+0x11b0>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204aa2:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204aa6:	00002c17          	auipc	s8,0x2
ffffffffc0204aaa:	492c0c13          	addi	s8,s8,1170 # ffffffffc0206f38 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204aae:	000d4503          	lbu	a0,0(s10) # 1000 <BASE_ADDRESS-0xffffffffc01ff000>
ffffffffc0204ab2:	02500793          	li	a5,37
ffffffffc0204ab6:	001d0413          	addi	s0,s10,1
ffffffffc0204aba:	00f50e63          	beq	a0,a5,ffffffffc0204ad6 <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0204abe:	c521                	beqz	a0,ffffffffc0204b06 <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ac0:	02500993          	li	s3,37
ffffffffc0204ac4:	a011                	j	ffffffffc0204ac8 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0204ac6:	c121                	beqz	a0,ffffffffc0204b06 <vprintfmt+0x92>
            putch(ch, putdat);
...
ffffffffc0204ad2:	ff351ae3          	bne	a0,s3,ffffffffc0204ac6 <vprintfmt+0x52>
ffffffffc0204ad6:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204ada:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204ade:	4981                	li	s3,0
ffffffffc0204ae0:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0204ae2:	5cfd                	li	s9,-1
ffffffffc0204ae4:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ae6:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0204aea:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204aec:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0204af0:	0ff6f693          	andi	a3,a3,255
ffffffffc0204af4:	00140d13          	addi	s10,s0,1
ffffffffc0204af8:	20d5e563          	bltu	a1,a3,ffffffffc0204d02 <vprintfmt+0x28e>
ffffffffc0204afc:	068a                	slli	a3,a3,0x2
ffffffffc0204afe:	96d2                	add	a3,a3,s4
ffffffffc0204b00:	4294                	lw	a3,0(a3)
...
ffffffffc0204b22:	8082                	ret
    if (lflag >= 2) {
ffffffffc0204b24:	4705                	li	a4,1
ffffffffc0204b26:	008a8593          	addi	a1,s5,8
ffffffffc0204b2a:	01074463          	blt	a4,a6,ffffffffc0204b32 <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0204b2e:	26080363          	beqz	a6,ffffffffc0204d94 <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0204b32:	000ab603          	ld	a2,0(s5)
ffffffffc0204b36:	46c1                	li	a3,16
ffffffffc0204b38:	8aae                	mv	s5,a1
ffffffffc0204b3a:	a06d                	j	ffffffffc0204be4 <vprintfmt+0x170>
            goto reswitch;
ffffffffc0204b3c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204b40:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b42:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204b44:	b765                	j	ffffffffc0204aec <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0204b46:	000aa503          	lw	a0,0(s5)
ffffffffc0204b4a:	85a6                	mv	a1,s1
ffffffffc0204b4c:	0aa1                	addi	s5,s5,8
ffffffffc0204b4e:	9902                	jalr	s2
            break;
ffffffffc0204b50:	bfb9                	j	ffffffffc0204aae <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204b52:	4705                	li	a4,1
ffffffffc0204b54:	008a8993          	addi	s3,s5,8
ffffffffc0204b58:	01074463          	blt	a4,a6,ffffffffc0204b60 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0204b5c:	22080463          	beqz	a6,ffffffffc0204d84 <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0204b60:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0204b64:	24044463          	bltz	s0,ffffffffc0204dac <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0204b68:	8622                	mv	a2,s0
ffffffffc0204b6a:	8ace                	mv	s5,s3
ffffffffc0204b6c:	46a9                	li	a3,10
ffffffffc0204b6e:	a89d                	j	ffffffffc0204be4 <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0204b70:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b74:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204b76:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0204b78:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204b7c:	8fb5                	xor	a5,a5,a3
ffffffffc0204b7e:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b82:	1ad74363          	blt	a4,a3,ffffffffc0204d28 <vprintfmt+0x2b4>
ffffffffc0204b86:	00369793          	slli	a5,a3,0x3
ffffffffc0204b8a:	97e2                	add	a5,a5,s8
ffffffffc0204b8c:	639c                	ld	a5,0(a5)
ffffffffc0204b8e:	18078d63          	beqz	a5,ffffffffc0204d28 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204b92:	86be                	mv	a3,a5
ffffffffc0204b94:	00000617          	auipc	a2,0x0
ffffffffc0204b98:	38c60613          	addi	a2,a2,908 # ffffffffc0204f20 <etext+0x28>
ffffffffc0204b9c:	85a6                	mv	a1,s1
ffffffffc0204b9e:	854a                	mv	a0,s2
ffffffffc0204ba0:	240000ef          	jal	ra,ffffffffc0204de0 <printfmt>
ffffffffc0204ba4:	b729                	j	ffffffffc0204aae <vprintfmt+0x3a>
            lflag ++;
ffffffffc0204ba6:	00144603          	lbu	a2,1(s0)
ffffffffc0204baa:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bac:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bae:	bf3d                	j	ffffffffc0204aec <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0204bb0:	4705                	li	a4,1
ffffffffc0204bb2:	008a8593          	addi	a1,s5,8
ffffffffc0204bb6:	01074463          	blt	a4,a6,ffffffffc0204bbe <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0204bba:	1e080263          	beqz	a6,ffffffffc0204d9e <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0204bbe:	000ab603          	ld	a2,0(s5)
ffffffffc0204bc2:	46a1                	li	a3,8
ffffffffc0204bc4:	8aae                	mv	s5,a1
ffffffffc0204bc6:	a839                	j	ffffffffc0204be4 <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0204bc8:	03000513          	li	a0,48
ffffffffc0204bcc:	85a6                	mv	a1,s1
ffffffffc0204bce:	e03e                	sd	a5,0(sp)
...
ffffffffc0204bdc:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0204be0:	6782                	ld	a5,0(sp)
ffffffffc0204be2:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204be4:	876e                	mv	a4,s11
ffffffffc0204be6:	85a6                	mv	a1,s1
ffffffffc0204be8:	854a                	mv	a0,s2
ffffffffc0204bea:	e1fff0ef          	jal	ra,ffffffffc0204a08 <printnum>
            break;
ffffffffc0204bee:	b5c1                	j	ffffffffc0204aae <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204bf0:	000ab603          	ld	a2,0(s5)
ffffffffc0204bf4:	0aa1                	addi	s5,s5,8
ffffffffc0204bf6:	1c060663          	beqz	a2,ffffffffc0204dc2 <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0204bfa:	00160413          	addi	s0,a2,1
ffffffffc0204bfe:	17b05c63          	blez	s11,ffffffffc0204d76 <vprintfmt+0x302>
ffffffffc0204c02:	02d00593          	li	a1,45
ffffffffc0204c06:	14b79263          	bne	a5,a1,ffffffffc0204d4a <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c0a:	00064783          	lbu	a5,0(a2)
ffffffffc0204c0e:	0007851b          	sext.w	a0,a5
ffffffffc0204c12:	c905                	beqz	a0,ffffffffc0204c42 <vprintfmt+0x1ce>
ffffffffc0204c14:	000cc563          	bltz	s9,ffffffffc0204c1e <vprintfmt+0x1aa>
ffffffffc0204c18:	3cfd                	addiw	s9,s9,-1
ffffffffc0204c1a:	036c8263          	beq	s9,s6,ffffffffc0204c3e <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0204c1e:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c20:	18098463          	beqz	s3,ffffffffc0204da8 <vprintfmt+0x334>
ffffffffc0204c24:	3781                	addiw	a5,a5,-32
ffffffffc0204c26:	18fbf163          	bleu	a5,s7,ffffffffc0204da8 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0204c2a:	03f00513          	li	a0,63
ffffffffc0204c2e:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c30:	0405                	addi	s0,s0,1
ffffffffc0204c32:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204c36:	3dfd                	addiw	s11,s11,-1
ffffffffc0204c38:	0007851b          	sext.w	a0,a5
ffffffffc0204c3c:	fd61                	bnez	a0,ffffffffc0204c14 <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0204c3e:	e7b058e3          	blez	s11,ffffffffc0204aae <vprintfmt+0x3a>
ffffffffc0204c42:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204c44:	85a6                	mv	a1,s1
ffffffffc0204c46:	02000513          	li	a0,32
ffffffffc0204c4a:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c4c:	e60d81e3          	beqz	s11,ffffffffc0204aae <vprintfmt+0x3a>
ffffffffc0204c50:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204c52:	85a6                	mv	a1,s1
ffffffffc0204c54:	02000513          	li	a0,32
ffffffffc0204c58:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c5a:	fe0d94e3          	bnez	s11,ffffffffc0204c42 <vprintfmt+0x1ce>
ffffffffc0204c5e:	bd81                	j	ffffffffc0204aae <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c60:	4705                	li	a4,1
ffffffffc0204c62:	008a8593          	addi	a1,s5,8
ffffffffc0204c66:	01074463          	blt	a4,a6,ffffffffc0204c6e <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0204c6a:	12080063          	beqz	a6,ffffffffc0204d8a <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0204c6e:	000ab603          	ld	a2,0(s5)
ffffffffc0204c72:	46a9                	li	a3,10
ffffffffc0204c74:	8aae                	mv	s5,a1
ffffffffc0204c76:	b7bd                	j	ffffffffc0204be4 <vprintfmt+0x170>
ffffffffc0204c78:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0204c7c:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c80:	846a                	mv	s0,s10
ffffffffc0204c82:	b5ad                	j	ffffffffc0204aec <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0204c84:	85a6                	mv	a1,s1
ffffffffc0204c86:	02500513          	li	a0,37
ffffffffc0204c8a:	9902                	jalr	s2
            break;
ffffffffc0204c8c:	b50d                	j	ffffffffc0204aae <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0204c8e:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc0204c92:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c96:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c98:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0204c9a:	e40dd9e3          	bgez	s11,ffffffffc0204aec <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0204c9e:	8de6                	mv	s11,s9
ffffffffc0204ca0:	5cfd                	li	s9,-1
ffffffffc0204ca2:	b5a9                	j	ffffffffc0204aec <vprintfmt+0x78>
            goto reswitch;
ffffffffc0204ca4:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0204ca8:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cac:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204cae:	bd3d                	j	ffffffffc0204aec <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0204cb0:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc0204cb4:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cb8:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204cba:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204cbe:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204cc2:	fcd56ce3          	bltu	a0,a3,ffffffffc0204c9a <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0204cc6:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204cc8:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0204ccc:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204cd0:	0196873b          	addw	a4,a3,s9
ffffffffc0204cd4:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204cd8:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0204cdc:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0204ce0:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0204ce4:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204ce8:	fcd57fe3          	bleu	a3,a0,ffffffffc0204cc6 <vprintfmt+0x252>
ffffffffc0204cec:	b77d                	j	ffffffffc0204c9a <vprintfmt+0x226>
            if (width < 0)
ffffffffc0204cee:	fffdc693          	not	a3,s11
ffffffffc0204cf2:	96fd                	srai	a3,a3,0x3f
ffffffffc0204cf4:	00ddfdb3          	and	s11,s11,a3
ffffffffc0204cf8:	00144603          	lbu	a2,1(s0)
ffffffffc0204cfc:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cfe:	846a                	mv	s0,s10
ffffffffc0204d00:	b3f5                	j	ffffffffc0204aec <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc0204d02:	85a6                	mv	a1,s1
ffffffffc0204d04:	02500513          	li	a0,37
ffffffffc0204d08:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204d0a:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204d0e:	02500793          	li	a5,37
ffffffffc0204d12:	8d22                	mv	s10,s0
ffffffffc0204d14:	d8f70de3          	beq	a4,a5,ffffffffc0204aae <vprintfmt+0x3a>
ffffffffc0204d18:	02500713          	li	a4,37
ffffffffc0204d1c:	1d7d                	addi	s10,s10,-1
ffffffffc0204d1e:	fffd4783          	lbu	a5,-1(s10)
ffffffffc0204d22:	fee79de3          	bne	a5,a4,ffffffffc0204d1c <vprintfmt+0x2a8>
ffffffffc0204d26:	b361                	j	ffffffffc0204aae <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d28:	00002617          	auipc	a2,0x2
ffffffffc0204d2c:	2e860613          	addi	a2,a2,744 # ffffffffc0207010 <error_string+0xd8>
ffffffffc0204d30:	85a6                	mv	a1,s1
ffffffffc0204d32:	854a                	mv	a0,s2
ffffffffc0204d34:	0ac000ef          	jal	ra,ffffffffc0204de0 <printfmt>
ffffffffc0204d38:	bb9d                	j	ffffffffc0204aae <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d3a:	00002617          	auipc	a2,0x2
ffffffffc0204d3e:	2ce60613          	addi	a2,a2,718 # ffffffffc0207008 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc0204d42:	00002417          	auipc	s0,0x2
ffffffffc0204d46:	2c740413          	addi	s0,s0,711 # ffffffffc0207009 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d4a:	8532                	mv	a0,a2
ffffffffc0204d4c:	85e6                	mv	a1,s9
ffffffffc0204d4e:	e032                	sd	a2,0(sp)
ffffffffc0204d50:	e43e                	sd	a5,8(sp)
ffffffffc0204d52:	0cc000ef          	jal	ra,ffffffffc0204e1e <strnlen>
ffffffffc0204d56:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d5a:	6602                	ld	a2,0(sp)
ffffffffc0204d5c:	01b05d63          	blez	s11,ffffffffc0204d76 <vprintfmt+0x302>
ffffffffc0204d60:	67a2                	ld	a5,8(sp)
ffffffffc0204d62:	2781                	sext.w	a5,a5
ffffffffc0204d64:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc0204d66:	6522                	ld	a0,8(sp)
ffffffffc0204d68:	85a6                	mv	a1,s1
ffffffffc0204d6a:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d6c:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d6e:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d70:	6602                	ld	a2,0(sp)
ffffffffc0204d72:	fe0d9ae3          	bnez	s11,ffffffffc0204d66 <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d76:	00064783          	lbu	a5,0(a2)
ffffffffc0204d7a:	0007851b          	sext.w	a0,a5
ffffffffc0204d7e:	e8051be3          	bnez	a0,ffffffffc0204c14 <vprintfmt+0x1a0>
ffffffffc0204d82:	b335                	j	ffffffffc0204aae <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc0204d84:	000aa403          	lw	s0,0(s5)
ffffffffc0204d88:	bbf1                	j	ffffffffc0204b64 <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc0204d8a:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d8e:	46a9                	li	a3,10
ffffffffc0204d90:	8aae                	mv	s5,a1
ffffffffc0204d92:	bd89                	j	ffffffffc0204be4 <vprintfmt+0x170>
ffffffffc0204d94:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d98:	46c1                	li	a3,16
ffffffffc0204d9a:	8aae                	mv	s5,a1
ffffffffc0204d9c:	b5a1                	j	ffffffffc0204be4 <vprintfmt+0x170>
ffffffffc0204d9e:	000ae603          	lwu	a2,0(s5)
ffffffffc0204da2:	46a1                	li	a3,8
ffffffffc0204da4:	8aae                	mv	s5,a1
ffffffffc0204da6:	bd3d                	j	ffffffffc0204be4 <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc0204da8:	9902                	jalr	s2
ffffffffc0204daa:	b559                	j	ffffffffc0204c30 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc0204dac:	85a6                	mv	a1,s1
ffffffffc0204dae:	02d00513          	li	a0,45
ffffffffc0204db2:	e03e                	sd	a5,0(sp)
ffffffffc0204db4:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204db6:	8ace                	mv	s5,s3
ffffffffc0204db8:	40800633          	neg	a2,s0
ffffffffc0204dbc:	46a9                	li	a3,10
ffffffffc0204dbe:	6782                	ld	a5,0(sp)
ffffffffc0204dc0:	b515                	j	ffffffffc0204be4 <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc0204dc2:	01b05663          	blez	s11,ffffffffc0204dce <vprintfmt+0x35a>
ffffffffc0204dc6:	02d00693          	li	a3,45
ffffffffc0204dca:	f6d798e3          	bne	a5,a3,ffffffffc0204d3a <vprintfmt+0x2c6>
ffffffffc0204dce:	00002417          	auipc	s0,0x2
ffffffffc0204dd2:	23b40413          	addi	s0,s0,571 # ffffffffc0207009 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dd6:	02800513          	li	a0,40
ffffffffc0204dda:	02800793          	li	a5,40
ffffffffc0204dde:	bd1d                	j	ffffffffc0204c14 <vprintfmt+0x1a0>
...
ffffffffc0204df4:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204df6:	c7fff0ef          	jal	ra,ffffffffc0204a74 <vprintfmt>
}
...
ffffffffc0204e04:	cb91                	beqz	a5,ffffffffc0204e18 <strlen+0x18>
    size_t cnt = 0;
...
ffffffffc0204e12:	fb7d                	bnez	a4,ffffffffc0204e08 <strlen+0x8>
    }
    return cnt;
}
ffffffffc0204e14:	853e                	mv	a0,a5
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e1e:	c185                	beqz	a1,ffffffffc0204e3e <strnlen+0x20>
ffffffffc0204e20:	00054783          	lbu	a5,0(a0)
ffffffffc0204e24:	cf89                	beqz	a5,ffffffffc0204e3e <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0204e26:	4781                	li	a5,0
ffffffffc0204e28:	a021                	j	ffffffffc0204e30 <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e2a:	00074703          	lbu	a4,0(a4)
ffffffffc0204e2e:	c711                	beqz	a4,ffffffffc0204e3a <strnlen+0x1c>
        cnt ++;
ffffffffc0204e30:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e32:	00f50733          	add	a4,a0,a5
ffffffffc0204e36:	fef59ae3          	bne	a1,a5,ffffffffc0204e2a <strnlen+0xc>
    }
    return cnt;
}
...
ffffffffc0204e44:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204e46:	0585                	addi	a1,a1,1
ffffffffc0204e48:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204e4c:	0785                	addi	a5,a5,1
ffffffffc0204e4e:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e52:	fb75                	bnez	a4,ffffffffc0204e46 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204e5e:	cb91                	beqz	a5,ffffffffc0204e72 <strcmp+0x1c>
ffffffffc0204e60:	00e79c63          	bne	a5,a4,ffffffffc0204e78 <strcmp+0x22>
        s1 ++, s2 ++;
...
ffffffffc0204e6c:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e70:	fbe5                	bnez	a5,ffffffffc0204e60 <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e72:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e74:	9d19                	subw	a0,a0,a4
ffffffffc0204e76:	8082                	ret
ffffffffc0204e78:	0007851b          	sext.w	a0,a5
ffffffffc0204e7c:	9d19                	subw	a0,a0,a4
ffffffffc0204e7e:	8082                	ret

ffffffffc0204e80 <strchr>:
...
ffffffffc0204e84:	cb91                	beqz	a5,ffffffffc0204e98 <strchr+0x18>
        if (*s == c) {
ffffffffc0204e86:	00b79563          	bne	a5,a1,ffffffffc0204e90 <strchr+0x10>
ffffffffc0204e8a:	a809                	j	ffffffffc0204e9c <strchr+0x1c>
ffffffffc0204e8c:	00b78763          	beq	a5,a1,ffffffffc0204e9a <strchr+0x1a>
            return (char *)s;
        }
        s ++;
...
ffffffffc0204e96:	fbfd                	bnez	a5,ffffffffc0204e8c <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e9e:	ca01                	beqz	a2,ffffffffc0204eae <memset+0x10>
ffffffffc0204ea0:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ea2:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ea4:	0785                	addi	a5,a5,1
ffffffffc0204ea6:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204eaa:	fec79de3          	bne	a5,a2,ffffffffc0204ea4 <memset+0x6>
    }
    return s;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204ec8:	c21d                	beqz	a2,ffffffffc0204eee <memcmp+0x26>
        if (*s1 != *s2) {
ffffffffc0204eca:	00054783          	lbu	a5,0(a0)
ffffffffc0204ece:	0005c703          	lbu	a4,0(a1)
ffffffffc0204ed2:	962a                	add	a2,a2,a0
ffffffffc0204ed4:	00f70963          	beq	a4,a5,ffffffffc0204ee6 <memcmp+0x1e>
ffffffffc0204ed8:	a829                	j	ffffffffc0204ef2 <memcmp+0x2a>
ffffffffc0204eda:	00054783          	lbu	a5,0(a0)
ffffffffc0204ede:	0005c703          	lbu	a4,0(a1)
ffffffffc0204ee2:	00e79863          	bne	a5,a4,ffffffffc0204ef2 <memcmp+0x2a>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204ee6:	0505                	addi	a0,a0,1
ffffffffc0204ee8:	0585                	addi	a1,a1,1
    while (n -- > 0) {
ffffffffc0204eea:	fea618e3          	bne	a2,a0,ffffffffc0204eda <memcmp+0x12>
    }
    return 0;
...
ffffffffc0204ef0:	8082                	ret
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204ef2:	40e7853b          	subw	a0,a5,a4
